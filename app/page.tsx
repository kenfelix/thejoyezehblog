...
const Home: FC<HomeProps> = () => {
  return (
    <div>
      ...
      <div className='p-[60px] flex flex-row gap-[50px]'>
        {/* left */}
        <div className='w-[65%]'>
          <div className='flex flex-col space-y-[50px]'>
            <div className='relative h-[400px] w-full'>
              ...
              />
              <div className='absolute inset-0 bg-black w-[45%] h-[310px] opacity-[70%] z-10 p-3'>
